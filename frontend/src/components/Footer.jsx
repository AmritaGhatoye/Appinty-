    ...
    <strong>Appointy – Effortless Healthcare Scheduling
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-gray-600">
            <li>Amrita</li>
            <li>+91 720693570</li>
            <li>ghatoyeamrita@gmail.com</li>
            <li><a href="https://linkedin.com/in/amrita-ghatoye" target="_blank" rel="noopener noreferrer" className="hover:underline">LinkedIn</a> | <a href="https://github.com/AmritaGhatoye" target="_blank" rel="noopener noreferrer" className="hover:underline">GitHub</a></li>
          </ul>
        </div>
      </div>
